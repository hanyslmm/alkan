...
while(counter < total_logicallink):
    if counter < 10:
        with tag('logicallink'):
            ...
            text('stacktype=IP')
            text('\n')
            text('name=SS23-MGWO1-MGWO1-SS23-0{}_'.format(counter))
            text('\n')
            text('assocname=SS23-MGWO1-MGWO1-SS23-0{}'.format(counter))
            text('\n')
    else:
        with tag('logicallink'):
            text('\n')
            text('stacktype=IP')
            text('\n')
            text('name=SS23-MGWO1-MGWO1-SS23-{}_'.format(counter))
            text('\n')
            text('assocname=SS23-MGWO1-MGWO1-SS23-{}'.format(counter))
            text('\n')
